...
// These records override trainer-operation fallbacks only where horse-level/current-stable evidence supports the location.
(function(){
  const upgrades={
    ...
    'Changingoftheguard':{trainingBase:'Newcastle, NSW',stateCountry:'Australia',verifiedDate:'2026-09-15',source:'Current Australian campaign under Newcastle-based Kris Lees',sourceUrl:'https://www.races.com.au/2026/04/11/sydney-cup-2026-results-changingoftheguard-wins-at-50-1/',confidence:'Verified current trainer/location evidence',basis:'HORSE_SPECIFIC_CURRENT',horseSpecificCurrentVerified:true,trainerOperationFallback:false},
    'Asterix':{trainingBase:'Flemington, VIC',stateCountry:'Australia',verifiedDate:'2026-09-15',source:'Racing NSW horse profile — Trainer Chris Waller (Flemington)',sourceUrl:'https://mdata.racingnsw.com.au/InteractiveForm/HorseFullForm.aspx?Key=2026Mar24%2CNSW%2CRosehill+Gardens%2CTrial&horsecode=Nzk0MzQ4Mjk2Mg%3D%3D&raceentry=MjMyMDAwMDMyOTY%3D&src=horseform&stage=FinalFields',confidence:'Verified horse-specific profile',basis:'HORSE_SPECIFIC_CURRENT',horseSpecificCurrentVerified:true,trainerOperationFallback:false},
    'Athabascan':{trainingBase:'Randwick, NSW',stateCountry:'Australia',verifiedDate:'2026-09-15',source:'Racing NSW trainer/current-run record — Athabascan shown (Randwick) under Tom Charlton',sourceUrl:'https://mdata.racingnsw.com.au/InteractiveForm/TrainerLastRuns.aspx?trainercode=OTg4OTcxNDcwMA%3D%3D&trainername=Tom+Charlton',confidence:'Verified horse-specific stable/run location',basis:'HORSE_SPECIFIC_CURRENT',horseSpecificCurrentVerified:true,trainerOperationFallback:false},
    'Darkbonee':{trainingBase:'Warrnambool, VIC',stateCountry:'Australia',verifiedDate:'2026-09-15',source:'Breednet horse profile — Trainer Symon Wilde, Warrnambool',sourceUrl:'https://www.breednet.com.au/horse/darkbonee',confidence:'Verified horse-specific current profile',basis:'HORSE_SPECIFIC_CURRENT',horseSpecificCurrentVerified:true,trainerOperationFallback:false},
    'Future History':{trainingBase:'Warwick Farm, NSW',stateCountry:'Australia',verifiedDate:'2026-09-15',source:'Racing NSW current stable — Gregory Hickman lists Future History; trainer location Warwick Farm',sourceUrl:'https://mdata.racingnsw.com.au/InteractiveForm/TrainerLastRuns.aspx?trainercode=Mjk5Mjc3OTA%3D&trainername=Gregory+Hickman',confidence:'Verified current-stable horse evidence',basis:'HORSE_SPECIFIC_CURRENT',horseSpecificCurrentVerified:true,trainerOperationFallback:false}
  };
