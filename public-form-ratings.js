...
// PFR remains a transparent Hub scale. Where an authoritative public Racing And Sports peak
// benchmark has been published, it is exposed separately as RAS Peak and never relabelled PFR/Timeform.

const PUBLIC_FORM_RATING_VERSION='PFR-1.1';
const RAS_PUBLIC_PEAKS={
  'Christmas Day':123,'Defiantly':121,'Hopewell Rock':117,'Stinger Glass':117,'Trustyourinstinct':117,'Wine Dark Sea':117,
  'Tawny Port':116,'Goodie Two Shoes':114,'James J Braddock':114,'Small Fry':113,'Amelia Earhart':108,'Highwayman':107
};
...
function publicRatedRuns(name){const runs=(typeof publicActualRuns==='function'?publicActualRuns(name):(formIntelData?.horses?.[name]?.runs||[]));return runs.map(r=>({...r,publicRating:publicRunRating(r)}));}
